# transaction-data-builder Specification

## Purpose

This specification defines the Transaction Data builder feature for OID4VP authorization flows. Transaction data allows verifiers to include transaction-specific information that wallets can use for Strong Customer Authentication (SCA) in payment scenarios.
